...
void Npc::Init(int id, sf::Vector2i startGridPos, Player* player, Npc* blinky)
{
    ...
    context.ghost = this;
    context.ghostID = id; // On définit l'ID tout de suite pour pouvoir utiliser SetTargetToCorner
    ...
    context.currentDirection = Direction::None; // Pas de direction initiale forcée
